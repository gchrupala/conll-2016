...
perspective, we compare it to two word-level models. The performance of these models should not be seen as a baseline, as they exploit information that is unavailable to {\sc Phon GRU}: the identity of words is unambiguous to them.
