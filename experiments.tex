...
\begin{table}[]
	...
	\end{tabular}
	\caption{Spearman's rank correlation between cosine similarity and human similarity judgements. All correlations are significant at \textit{p} < 0.05.} % bad title
\end{table}
...
%should you report p-values for correlations?
...
\begin{table}[]
	...
	\begin{tabular}{cc}
		...
		Layer 3 & -0.15
	\end{tabular}
	\caption{Spearman's rank correlation between cosine similarity and edit distance} % bad title
\end{table}
